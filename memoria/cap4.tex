...
\begin{itemize}
  ...
  \item Permite a\~{n}adir un \ceit{header} y un \ceit{footer} personalizado al cuestionario que se generar\'a. Se deber\'a indicar
...
Se ha tratado de usar \ceis{Opal} para traducir preguntas escritas en \ceit{Ruby} a \ceit{JavaScript} y poder validarlas desde el navegador.
Se consigui\'o en parte, pues no fue posible obtener el c\'odigo de una \cei{Lambda} o un \cei{Proc}, ya que Ruby los evaluaba antes de llegar al
JavaScript.
\bigskip
