...
\begin{enumerate}
  ...
  \item El \ceit{path} de un fichero \ceis{CSV} con los datos de los alumnos.
  \begin{figure}[!th]
  \begin{center}
...
Usar como servidor \ceis{WeBrick} en lugar del que ejecuta Sinatra por defecto (\ceis{Thin}). WeBrick no permite m\'ultiples peticiones por lo que se nos muestra la 
