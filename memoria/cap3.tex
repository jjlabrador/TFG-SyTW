...
Tras realizar el correspondiente \cei{fork} en \ceit{GitHub} para empezar a implementar mis modificaciones, ejecut\'e los tests de la 
...
mismo modo, algunas gemas de \ceit{testing} existentes en el \ceit{Gemfile} presentaban incompatibilidades con las nuevas versiones de \ceit{Ruby}, por
