...
dudas de manera incansable en la realización del Trabajo de Fin de Grado. Ha sido un verdadero 
placer gozar de su conocimiento y experiencia. Estoy seguro de que la experiencia adquirida 
me ayudar\'a en mis pr\'oximas etapas.
...
En este Trabajo de Fin de Grado se propone, en concreto, el desarrollo de una aplicaci\'on web para la 
elaboraci\'on y despliegue de cuestionarios en la que se consideran diversos roles de usuarios y los problemas 
de seguridad asociados. Además, para su desarrollo, se ha hecho uso de un Lenguaje de Dominio Espec\'{\i}fico 
(DSL) implementado en Ruby por Armando Fox denominado \href{http://github.com/saasbook/ruql}{'Ruby-based Quiz Generator and DSL'} 
(RuQL).

}

\begin{palabrasClave}
Cuestionario, Lenguaje de Dominio Espec\'{\i}fico, DSL, Ruby, RuQL
\end{palabrasClave}
...
% ha puesto.
\markboth{Juan Jos\'e Labrador Gonz\'alez}{Título del proyecto}
