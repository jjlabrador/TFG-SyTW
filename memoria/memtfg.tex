...
% Reference name of description list item
\makeatletter
...
Existe un buen n\'umero de plataformas y herramientas para la generaci\'on de este tipo de cuestionarios.
...
se cuenta con la posibilidad de a\~{n}adir preguntas cuyas respuestas son evaluadas por programas escritos por el profesor. 
\bigskip
...
\chapter{Generando HTML para el entrenamiento del alumno: HtmlForm renderer}
...
%XXXXX añadir referencias a Moodle y a otros sistemas de evaluación automática
% y en la intro y las conclusiones citar esas referencias
% http://www.gla.ac.uk/media/media_231899_en.pdf
\bibliography{memtfg}
\nocite{*}

\addcontentsline{toc}{bibliography}{Bibliografía}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
